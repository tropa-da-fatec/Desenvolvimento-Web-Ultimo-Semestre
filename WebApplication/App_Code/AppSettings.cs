...
using Datapost.DB;
    ...
    public class DataBase
    {
        ...
        public static void Open()
        {
            ...
            Command.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + HttpContext.Current.Server.MapPath("~/App_Data/SI20232.accdb") + ";Persist Security Info=False;";
        }
